# Codebase Briefing — Square POS Phase
...
These are enforced via `ARCHITECTURE_RULES.md` and architecture tests:
...
| File | Why It Matters |
|---|---|
| `ARCHITECTURE_RULES.md` | Architecture contract — read before writing any code |
