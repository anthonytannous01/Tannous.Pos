...
_Assessed 2026-09-04, after Step 118._
...
### 3. Known security advisory accepted but never revisited

AutoMapper 12.0.1 carries **NU1903** (GHSA-rvv3-g6hj-g44x). Documented as accepted debt in
§12 with an upgrade "planned". Still 12.0.1.
